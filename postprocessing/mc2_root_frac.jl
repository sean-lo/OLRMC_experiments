...
combine_df = CSV.read("mc_root_frac/rank2/summary.csv", DataFrame)
...
savefig("postprocessing/plots/mc2_root_loglb_smalllarge_80.0.pdf")
...
savefig("postprocessing/plots/mc2_root_time_smalllarge_80.0.pdf")
...
savefig("postprocessing/plots/mc2_root_lb_time_smalllarge_$(γ)_$(Shor_valid_inequalities_noisy_rank1_num_entries_present).pdf")