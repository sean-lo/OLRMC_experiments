...
for row_index in task_index:n_tasks:size(args_df, 1)
    ...
    max_altmin_probability = args_df[row_index, :max_altmin_probability]
    min_altmin_probability = args_df[row_index, :min_altmin_probability]
    altmin_probability_decay_rate = args_df[row_index, :altmin_probability_decay_rate]
